...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "ONEpk" },
      { title: "ONEpk — Lucky Draws, Wallet & Verified Deposits" },
      { name: "description", content: "Buy entries in verified ONEpk product draws, manage your wallet with JazzCash or EasyPaisa deposits and follow every winner." },
      { property: "og:title", content: "ONEpk — Lucky Draws, Wallet & Verified Deposits" },
      { name: "twitter:title", content: "ONEpk — Lucky Draws, Wallet & Verified Deposits" },
      { property: "og:description", content: "Buy entries in verified ONEpk product draws, manage your wallet with JazzCash or EasyPaisa deposits and follow every winner." },
      { name: "twitter:description", content: "Buy entries in verified ONEpk product draws, manage your wallet with JazzCash or EasyPaisa deposits and follow every winner." },
